/*
CIS162 Lab 5: Task Scheduler (nt_TaskScheduler2.cpp)
...
12/03/2011 - Modified TaskList.h and TaskList.cpp to implement the usage of linked list instead of pointers
			 and dynamic arrays.
*/
